...
export function ProductDetails({ product }: { product: DemoProduct }) {
  ...
  return (
    <aside className="self-start border border-[#171717] bg-white p-6 shadow-[8px_8px_0_#171717] lg:sticky lg:top-6">
      ...
      <button
        className="mt-7 flex min-h-14 w-full items-center justify-center border border-[#171717] bg-[#171717] px-5 text-sm font-bold uppercase tracking-[0.16em] text-white transition hover:bg-[#2b2b2b] disabled:cursor-not-allowed disabled:bg-[#696969]"
        type="button"
      ...
      <p className="mt-4 text-sm leading-6 text-[#4a4a4a]">
        {product.dataSource === "live"
          ? "Stripe Checkout collects payment and shipping. The webhook will create the fulfillment order in the next step."
